...
Use this when you import start or checkpoint items. (see the page [item import](../import-an-item))  
...
Use this when you import checkpoint or finish items. (see the page [item import](../import-an-item))  
