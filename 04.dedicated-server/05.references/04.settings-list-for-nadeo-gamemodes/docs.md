...
|:-:|:-:|:-:|
|**S_MatchmakingAPIUrl**|https://v4.live.maniaplanet.com/ingame/public/matchmaking|URL of the matchmaking API. If you don't plan to use a custom matchmaking function leave this setting at its default value.|
